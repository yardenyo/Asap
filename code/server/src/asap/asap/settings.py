"""
Django settings for asap project.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DJANGO_DATABASE_NAME', 'asap'),
        'USER': os.environ.get('DJANGO_DATABASE_USER', 'asap_db_root'),
        'PASSWORD': os.environ.get('DJANGO_DATABASE_PASSWORD', '6855b1aecc09da47765f0ca8633f92a6'),
