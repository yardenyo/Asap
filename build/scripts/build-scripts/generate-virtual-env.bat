...
python %PROJECT_NAME%\code\server\src\asap\manage.py collectstatic --no-input --clear
xcopy %PROJECT_NAME%\code\server\src\asap\static output\%PROJECT_NAME%\static\static\ /eqv
